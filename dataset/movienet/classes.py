...
K_V2 = torch.FloatTensor([[-20, -20, -20, -40, -20, -20, -20, -20, -20, -20, -20, -20, -20, -20, -20, -20, -20],
                          [-10, -10, -10, -20, -10, -10, -10, -10, -10, -10, -10, -10, -10, -10, -10, -10, -10],
                          [10, 10, 60, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10],
                          [20, 20, 90, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20]]).cuda()
...
Camera_Type_DICTIONARY = {"Main camera center": 0, "Close-up player or field referee": 1, "Main camera left": 2,
                          "Main camera right": 3, "Goal line technology camera": 4, "Main behind the goal": 5,
                          "Spider camera": 6,
                          "Close-up side staff": 7, "Close-up corner": 8, "Close-up behind the goal": 9,
                          "Inside the goal": 10, "Public": 11, "other": 12, "I don't know": 12}
...
Weight_camera_type = torch.tensor(
    [0.00143, 0.0003865, 0.0174, 0.0196, 0.128, 0.00171, 0.0552, 0.00239, 0.02, 0.00765, 0.1001, 0.0101, 0.594, 0.0253],
