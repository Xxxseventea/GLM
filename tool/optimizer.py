...
def build_optimizer(model, logger, **kwargs):
    """
    Build optimizer, set weight decay of normalization to 0 by default.
    """
    logger.info(f"==============> building optimizer adamw....................")
    skip = {}
    skip_keywords = {}
...
def build_optimizer_swimmim(config, model, logger, simmim=True, is_pretrain=False):
    ...
    if is_pretrain:
        ...
        parameters = get_finetune_param_groups(model, config.TRAIN.BASE_LR, config.TRAIN.WEIGHT_DECAY, get_layer_func,
                                               scales, skip, skip_keywords)
